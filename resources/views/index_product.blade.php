...
@section('content')
    <div class="container mx-auto">
        <h1 class="mb-4 text-center text-3xl font-bold">Semua Menu</h1>
        <div class="flex justify-center">
            <div class="w-1/2">
                <form action="{{ route('index_product') }}" method="get" class="flex">
                    <input type="text" class="form-input flex-1 border-2 border-gray-300 rounded-l-lg p-2" placeholder="Cari menu.." value="{{ request('search') }}" name="search">
                    <button class="bg-gray-200 border-2 border-gray-300 rounded-r-lg px-4 hover:bg-gray-300" type="submit" id="button-addon2">Cari</button>
                </form>
            </div>
        </div>
                        ...
                        @foreach ($products as $product)
                            <div class="w-full md:w-1/3 mb-4 px-2">
                                <div class="bg-white shadow-lg rounded-lg overflow-hidden">
                                    ...
                                    <img src="{{ url('/' . $product->image) }}" class="w-full" alt="{{ $product->name }}">
                                    <div class="p-4">
        ...
        @else
            ...
            <div class="bg-white mb-3 shadow overflow-hidden rounded-lg mt-8">
                <img src="https://assets.pikiran-rakyat.com/crop/0x88:720x646/1200x675/photo/2023/10/29/3798743674.jpeg" class="w-full" alt="...">
                <div class="p-4 text-center">
                    <h5 class="text-lg font-semibold">Bakso Bohai</h5>
                    <p class="text-base">Awas Ketagihan!!!</p>
                </div>
            </div>
        @endif
        @if (session('message'))
