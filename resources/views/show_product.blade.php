                ...
                <div class="bg-white shadow-lg rounded-lg overflow-hidden">
                    ...
                    <div class="p-2"> <!-- Mengurangi padding dari p-4 menjadi p-2 -->
                        ...
                        <div class="text-center">
                            ...
                            <img src="{{ url('/' . $product->image) }}" alt="Gambar Produk"
                                        ...
                                        <div class="flex justify-center space-x-2"> <!-- Mengurangi space-x dari space-x-4 menjadi space-x-2 -->
                                            ...
                                            <div class="w-1/2">
                                                <select name="color" class="form-select block w-full mt-1 rounded-md border-gray-300 shadow-sm" required>
                                                    <option value="" disabled selected>Toping</option>
                                                    <option value="Gorengan">Gorengan</option>
                                                    <option value="Siomay">Siomay</option>
                                                    <option value="Double Gorengan">Double Gorengan</option>
                                                    <option value="Double Siomay">Double Siomay</option>
                                                </select>
                                            </div>
                                        </div>
